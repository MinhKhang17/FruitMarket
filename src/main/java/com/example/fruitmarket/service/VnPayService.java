...
public class VnPayService {
    ...
    public String createPaymentUrl(HttpServletRequest request, BigDecimal amount, String orderInfo, Long orderId) throws Exception {
        String vnp_TxnRef = String.valueOf(System.currentTimeMillis()) + "OID" + orderId;
